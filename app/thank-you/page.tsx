      ...
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-10">
          ...
          <p className="text-white/80 text-xl leading-relaxed">
            Thanks for joining <strong style={{ color: '#F5C84C' }}>our community</strong> of concerned citizens and agreeing to get the <strong style={{ color: '#F5C84C' }}>latest scams</strong> and AI-powered fraud schemes — <strong style={{ color: '#F5C84C' }}>plus tips, tactics, and tricks</strong> to thwart them — sent right to your inbox monthly.
          </p>
