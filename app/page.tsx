    ...
    <div className={`${base} antialiased`}>
      ...
      <section id="demo" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className={`rounded-2xl border ${brandBorder} bg-white/5 p-6 lg:p-10 grid lg:grid-cols-2 gap-8 items-center`}>
          <div>
            <h3 className="text-3xl font-bold">Start with a suspicious message</h3>
      ...
      <section id="blog" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="hover-lift mb-6">
          <a href="/blog/she-heard-her-daughter-crying-ai-voice-clone-scam" className="block rounded-2xl border border-yellow-300/30 bg-yellow-300/5 p-8 hover:bg-yellow-300/10 transition-colors group">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div className="flex-1">
                <div className="text-xs font-bold tracking-widest text-yellow-300/70 mb-3">SCAM TRIAGE FILE #002</div>
                ...
                <p className="text-white/70 mb-4 max-w-2xl">
                  A Florida woman lost $15,000 to an AI voice clone scam — and every single red flag was catchable. The full playbook, the 7 red flags, and how to set up a family safe word today.
                </p>
                <div className="flex flex-wrap gap-6 text-sm">
                  <span className="text-white/50">May 23, 2026</span>
              ...
              <div className="flex gap-4 sm:flex-col sm:items-end shrink-0">
                <div className="text-right">
                  <div className="text-3xl font-extrabold text-red-400">$15,000</div>
                  <div className="text-xs text-white/40 uppercase tracking-wider">Loss</div>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-extrabold text-amber-400">~3 sec</div>
                  <div className="text-xs text-white/40 uppercase tracking-wider">Audio needed to clone</div>
                </div>
              </div>
            </div>
          </a>
